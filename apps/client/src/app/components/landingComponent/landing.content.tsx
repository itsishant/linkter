      ...
      <div className="mt-32 text-left">
        ...
        <div className="mt-44 flex justify-center items-center flex-col">
          ...
          <div className="flex flex-col items-start space-y-6">
            <p className="text-neutral-700 dark:text-neutral-400 font-sans text-xl font-semibold max-w-3xl text-center mt-8">{landingWorksPart.landingWorks.p1}</p>
            <p className="text-neutral-700 dark:text-neutral-400 text-xl font-sans max-w-3xl font-semibold text-center mt-4">{landingWorksPart.landingWorks.p2}</p>
            <p className="text-neutral-700 dark:text-neutral-400 text-xl font-sans max-w-3xl font-semibold text-center mt-4">{landingWorksPart.landingWorks.p3}</p>
            <p className="text-neutral-700 dark:text-neutral-400 text-xl font-sans max-w-3xl font-semibold text-center mt-4">{landingWorksPart.landingWorks.p4}</p>
          </div>
        </div>
    </div>
  );
