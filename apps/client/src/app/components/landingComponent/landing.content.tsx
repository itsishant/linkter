...
import Effect from "@components/splineComponent/splineContent";
    ...
    return (
        <div className="">
            <div className="mt-32 text-left">
                <div className="bg-clip-text text-transparent bg-gradient-to-b from-neutral-900 to-neutral-700 dark:from-neutral-600 dark:to-white text-8xl font-sans py-2 md:py-10 relative z-20 font-bold 
                ...
                <div className="max-w-2xl ml-46 text-xl tracking-tight text-neutral-700 dark:text-neutral-400 text-center">
                    <p className="">
                        {landingContentPart.landingContent.subHeading}
                    </p>
                </div>
